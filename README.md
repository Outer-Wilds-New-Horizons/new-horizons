...
If you want to quickly start a new addon see [the addon template](https://github.com/xen-42/ow-new-horizons-config-template) or [the outer wilds mod template](https://github.com/ow-mods/ow-mod-template) (check "Use New Horizons" when using the mod template).
